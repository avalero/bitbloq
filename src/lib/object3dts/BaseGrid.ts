 ...
 * Last modified  : 2018-11-06 11:52:36
 */
...
export default class BaseGrid{
  ...
  constructor(_size: number = 10, _divisions: number = 10, _subdivisions: number = 10, _color1:string = '0x444444', _color2: string = '0x888888'){
		const size = _size;
		...
		for ( let i = 0, j = 0, k = - halfSize; i <= divisions; i ++, k += step ) {
			...
			const color:THREE.Color = i === center ? color1 : color2;
